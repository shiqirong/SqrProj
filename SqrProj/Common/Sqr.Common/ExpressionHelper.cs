...
using static Sqr.Common.ExpressionHelper;
...
namespace Sqr.Common
{
    ...
    public static class PredicateExtensionses
    {
        ...
        public static Expression<Func<T, bool>> AndIf<T>(this Expression<Func<T, bool>> exp_left, Expression<Func<T, bool>> exp_right,bool condition)
        {
            if (condition)
                return exp_left;
            var candidateExpr = Expression.Parameter(typeof(T), "candidate");
        ...
        public static Expression<Func<T, bool>> OrIf<T>(this Expression<Func<T, bool>> exp_left, Expression<Func<T, bool>> exp_right, bool condition)
        {
            if (condition)
                return exp_left;
            var candidateExpr = Expression.Parameter(typeof(T), "candidate");
