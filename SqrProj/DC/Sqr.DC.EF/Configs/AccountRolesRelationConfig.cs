//-----------------------------------------------------------------------
// <copyright file=" AccountRolesRelation.cs" company="xxxx Enterprises">
...
{
    /// <summary>
    /// account_roles_relation Entity Model Config
    /// </summary>   
    public class AccountRolesRelationConfig :EntityTypeConfiguration<AccountRolesRelation>
    {
		public AccountRolesRelationConfig()
        {
            ToTable("account_roles_relation");
